...
def create_plot(df: pd.DataFrame, output_file: str) -> None:
    ...
    #     if text.get_text() == "DFTB":
    #         text.set_bbox({"boxstyle": "square,pad=0.2", "facecolor": "none", "edgecolor": "gray", "linewidth": 1.2, "linestyle": "dashed"})
    #     elif text.get_text() in ("4G-HDNNP", "QEq-MACE"):
    #         text.set_bbox({"boxstyle": "round,pad=0.2", "facecolor": "lightyellow", "edgecolor": "goldenrod", "linewidth": 1.2})
