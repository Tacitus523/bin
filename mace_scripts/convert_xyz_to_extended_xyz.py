...
ESP_GRAD_FILE: Optional[str] = "esp_gradients_conv.xyz" # eV/e/A to eV/e/A, xyz format, optional, gets filled with zeros if not present (could be transformed to electric field by multiplying by -1)
