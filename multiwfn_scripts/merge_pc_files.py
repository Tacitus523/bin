...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("-s", "--source", type=str, default=None, help="String to identify the simulation source")
...
def main(args: argparse.Namespace) -> None:
    ...
    for mm_system in mm_systems:
        for key in mm_system.arrays.keys():
            ...
            if key.startswith("E_elec_"):
                mm_system.info[key] *= hartree_to_ev
