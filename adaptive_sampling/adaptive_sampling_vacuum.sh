...
GMX_ENERGY_PREDICTION_STD_THRESHOLD=0.005 # Threshold for the energy standard deviation between models for a structure to be considered relevant
...
START_GEOMETRIES_PREFIX="/lustre/work/ws/ws1/ka_he8978-thiol_disulfide/training_data/B3LYP_aug-cc-pVTZ_vacuum/start_geometries/GEOM_" # Prefix(+Path) of folders with start geometries and topology, suffix should be continous integers starting from 0
...
GEOM_FILE="/lustre/work/ws/ws1/ka_he8978-thiol_disulfide/training_data/B3LYP_aug-cc-pVTZ_vacuum/ThiolDisulfidExchange.xyz" # Unit: Angstrom
ENERGY_FILE="/lustre/work/ws/ws1/ka_he8978-thiol_disulfide/training_data/B3LYP_aug-cc-pVTZ_vacuum/energy_diff.txt" # Unit: Hartree
ENERGY_REFERENCE_FILE="/lustre/work/ws/ws1/ka_he8978-thiol_disulfide/training_data/B3LYP_aug-cc-pVTZ_vacuum/energy_opt.txt" # to calculate the difference to a reference energy, contains energies of optimized fragments, optional, Unit: Hartree
CHARGE_FILE="/lustre/work/ws/ws1/ka_he8978-thiol_disulfide/training_data/B3LYP_aug-cc-pVTZ_vacuum/charges.txt" # Unit: e
FORCE_FILE="/lustre/work/ws/ws1/ka_he8978-thiol_disulfide/training_data/B3LYP_aug-cc-pVTZ_vacuum/forces.xyz" # Unit: Hartree/Bohr
DATA_SOURCES_FILE="/lustre/work/ws/ws1/ka_he8978-thiol_disulfide/training_data/B3LYP_aug-cc-pVTZ_vacuum/data_sources.txt" # Optional, Intended to keep track of different sampling methods. 1D column of strings with sampling description for plotting
...
extraction_script="/lustre/home/ka/ka_ipc/ka_he8978/bin/extract_qm_information.sh"
